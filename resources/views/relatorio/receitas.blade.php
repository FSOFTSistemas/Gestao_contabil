...
<body>
    ...
    <!-- Conteúdo -->
        <table class="table">
            ...
            <tbody>
                @php
                    $totalReceitas = 0; // Inicializa o total
                @endphp
                ...
                @foreach ($dados as $despesa)
                    ...
                    @php
                        $totalReceitas += $despesa->valor; // Soma o valor da despesa ao total
                    @endphp
                @endforeach
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="2" style="text-align: right; font-weight: bold;">Total de Receitas:</td>
                    <td style="font-weight: bold;">R$ {{ number_format($totalReceitas, 2, ',', '.') }}</td>
                </tr>
            </tfoot>
        </table>
