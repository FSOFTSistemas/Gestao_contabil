...
<tbody>
    ...
    <tr>
        ...
        <td>
            <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#viewClienteModal{{ $cliente->id }}">
                👁️
            </button>
            ...
            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteClienteModal{{ $cliente->id }}">
                🗑️
            </button>
        </td>
    </tr>
