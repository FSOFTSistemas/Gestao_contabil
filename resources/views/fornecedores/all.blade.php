        ...
        @foreach ($fornecedores as $f)
            <tr>
                ...
                <td>
                    ...
                    <!-- Botão para deletar -->
                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $f->id }}">
            ...
            <div class="modal fade" id="viewModal{{ $f->id }}" tabindex="-1" aria-labelledby="viewModalLabel{{ $f->id }}" aria-hidden="true">
